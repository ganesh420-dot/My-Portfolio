        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4 overflow-y-auto">
          <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-3xl overflow-hidden relative">
            ...
            <button
              ...
              className="absolute top-8 right-0 z-50 text-white text-3xl font-bold hover:text-purple-500"
            >
              &times;
            </button>
            ...
            <div className="flex flex-col">
              <div className="w-full flex justify-center bg-gray-900 px-4">
                <img
                  ...
                  className="lg:w-full w-[95%] object-contain rounded-xl shadow-2xl relative z-10"
                />
              </div>
