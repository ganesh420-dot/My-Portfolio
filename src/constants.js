...
export const projects = [
  ...
  },
  {
    ...
    title: "URL Shortener",
    description:
      "A full-stack URL Shortener built with Spring Boot and React. It features secure JWT authentication, PostgreSQL persistence, and Dockerized deployment. Users can create, manage, and track shortened URLs, with a modern UI powered by Tailwind CSS and Material UI. Deployed on Netlify, Render, and Neon Tech for a production-ready experience.",
    image: urlShortener,
    tags: [
      "React",
      "Vite",
